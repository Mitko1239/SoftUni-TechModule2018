...
namespace p06_AdvertisementMessage
{
    class P06
    {
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < numMessages; i++)
            {
                ...
                File.AppendAllText(outputFile, $"{advertisement.Phrase} {advertisement.Event} {advertisement.Author} - {advertisement.Town}" + Environment.NewLine);
            }
        }
    }
}
