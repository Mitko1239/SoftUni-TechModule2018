...
namespace p03_IntersectionOfCircles
{
    ...
    class Circle
    {
        ...
        {
            double distance = Math.Sqrt(Math.Abs(circle.Center.X - Center.X) * Math.Abs(circle.Center.X - Center.X) + Math.Abs(circle.Center.Y - Center.Y) * Math.Abs(circle.Center.Y - Center.Y));
